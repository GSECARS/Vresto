...
class CorrectionsGroupController:
    ...
    def __init__(
        ...
        check_mic_focus_correction: QCheckBox,
        ...
        self._check_mic_focus_correction = check_mic_focus_correction
    ...
    def _check_focus_sample_changed(self, state: int) -> None:
        if state:
            ...
            if self._microscope_focus.readback != 0.0:
                self._widget.check_focus_sample.setCheckState(Qt.CheckState.Unchecked)
                MsgBox(msg="First move the microscope focus to ZERO.")
                return None
    ...
    def _btn_real_position_clicked(self) -> None:
        ...
        if check_one and check_two and check_three:
            ...
            if self._check_mic_focus_correction.isChecked():
                self._correct_mic_focus_position(
    ...
    def _btn_reset_clicked(self) -> None:
        ...
        self._check_mic_focus_correction.setChecked(True)
    ...
    def _correct_mic_focus_position(
        ...
        try:
            ...
            self._microscope_focus.move(value=corrected_position)
