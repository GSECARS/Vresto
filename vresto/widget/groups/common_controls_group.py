...
class CommonControlsGroup(QFrame):
    ...
    def _layout_group(self) -> None:
        ...
        layout.addWidget(self.cmb_refraction_index, 2, 1, 1, 1)
        layout.addWidget(self.btn_load_correction, 3, 0, 1, 2)
        layout.addWidget(self.btn_save, 4, 0, 1, 1)
        layout.addWidget(self.btn_save_as, 4, 1, 1, 1)
        layout.addWidget(self.lbl_path, 5, 0, 1, 2)
