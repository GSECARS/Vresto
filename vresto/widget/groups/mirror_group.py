...
class MirrorGroup(QGroupBox):
    ...
    def __init__(self, paths: PathModel) -> None:
        ...
        self.setStyleSheet(
            open(os.path.join(self._paths.qss_path, "mirror_group.qss"), "r").read()
        )
    ...
    def _set_object_names(self) -> None:
        ...
        self.lbl_ds_position.setObjectName("lbl-mirror-positions")
        self.lbl_us_position.setObjectName("lbl-mirror-positions")
    ...
    def _layout_group(self) -> None:
        ...
        layout.addWidget(
            self._lbl_ds, 0, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter
        )
        layout.addWidget(
            self._lbl_us, 0, 2, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter
        )
        ...
        layout.addWidget(
            self.lbl_ds_position, 3, 0, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter
        )
        layout.addWidget(
            self.lbl_us_position, 3, 2, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter
        )
