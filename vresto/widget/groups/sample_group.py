...
class SampleGroup(QGroupBox):
    ...
    def _layout_group(self) -> None:
        ...
        layout.addWidget(
            self.line_vertical, 0, 7, 4, 2, alignment=Qt.AlignmentFlag.AlignHCenter
        )
        layout.addWidget(
            self.lbl_omega, 0, 9, 1, 2, alignment=Qt.AlignmentFlag.AlignCenter
        )
        layout.addLayout(
            layout_omega, 1, 9, 3, 2, alignment=Qt.AlignmentFlag.AlignCenter
        )
        layout.addLayout(
